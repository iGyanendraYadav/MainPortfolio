...
import Resume from "../images/Gyan.pdf";
        ...
        >
          <div className="leftOne   text-4xl md:text-4xl lg:text-6xl ">
            <motion.h1
              ...
              className="leading-[3rem] md:leading-[3rem] lg:leading-[5rem]"
            >
              Hey There,
            </motion.h1>
            <motion.h1
            ...
            <motion.h1
              ...
              className="leading-[3rem] md:leading-[3rem] lg:leading-[5rem] text-gray-500 dark:text-gray-300"
            >
              &lt;{" "}
            ...
            <div className="flex flex-row justify-evenly items-center space-x-5 md:space-x-6 lg:space-x-10 my-5 ">
              ...
              <a
                href="https://github.com/iGyanendraYadav"
                target="_blank"
                rel="noopener noreferrer"
              >
                <motion.div
              ...
              <a
                href="mailto:gyanindrayadav1@gmail.com"
                target="_blank"
                rel="noopener noreferrer"
              >
                <motion.div
              ...
              <a
                href="https://wa.me/+918896038076"
                target="_blank"
                rel="noopener noreferrer"
              >
                <motion.div
                  variants={theOpacity(1, 1)}
